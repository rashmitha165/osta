...
<html lang="en">
    ...
    <body class="fixed-left">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="media">
                                                <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-2.jpg" alt="Generic placeholder image">
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <div class="media">
                                                <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
        ...
        <!-- Page specific js -->
        <script src="assets/pages/dashborad-2.js"></script>
