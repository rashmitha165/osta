...
if(isset($_POST['submit']))
{
    ...
    $insert_query=mysqli_query($connection, "INSERT INTO student (sfname,slname,semail,smobile,spassword) VALUES ('$fname','$lname','$email','$mobile','$password')");
    if($insert_query)
    {
        ...
        <div class="wrapper-page">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <h4 class="font-18 m-b-5 text-center">Register as a Student</h4>
                        <p class="text-muted text-center">Get your free Student account to explore your talents.</p>
                        <?php if(isset($smsg)) { ?>
